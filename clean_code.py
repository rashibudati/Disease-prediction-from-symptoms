...
'yellow_crust_ooze', 'acidity',  'vomiting']
...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv("/home/rashi/Desktop/seventh-sem/minor/minor-code/Training.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv("/home/rashi/Desktop/seventh-sem/minor/minor-code/Testing.csv")
...
w2 = Label(root, justify=LEFT, text="A Project by GROUP 1", fg="white", bg="black")
